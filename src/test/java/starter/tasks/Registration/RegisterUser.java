...
public class RegisterUser implements Task {
   ...
   private final String expectedCountry;
    ...
    public RegisterUser(String expectedName,String expectedLastName,
                        String expectedAge,String expectedEmail,String expectedCountry){
    ...
    public <T extends Actor> void performAs(T actor) {
        try {
            actor.attemptsTo(
                    ...
                    Upload.theClasspathResource("images/adn.jpeg").to(RegisterForm.INPUT_PICTURE),
